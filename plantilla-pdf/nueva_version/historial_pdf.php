<?php
ob_start(); //prevenir errores antes de la salida del PDF
    ...
    if(!$id_paciente || !$especialidad){
        //se elimina el die() que causaba la salida HTML
   ...
   ob_end_clean(); //Limpiar cualquier salida previa antes del PDF
   $pdf->Output();
?>
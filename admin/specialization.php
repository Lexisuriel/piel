...
<style>
    ...
    #specializationListing thead {
        background-color: #2A9D8F;
        color: white;
    }
    
    #specializationListing th {
        padding: 12px 15px;
        font-weight: 500;
    }
    
    #specializationListing td {
        padding: 10px 12px;
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-2" align="right">
                            <button type="button" id="createSpecialization" class="btn btn-success" title="Create Specialization"><i class="fa fa-plus mr-2"></i>Add</button>
                        </div>
                        <?php } ?>
                    </div>
                </div>

<?php
session_start();
if (!isset($_SESSION['id_especialista']) || $_SESSION['especialidad'] !== 'Podologo') {
...
<head>
    <meta charset="UTF-8">
    <title>Dashboard - Podologo</title>
...
<body class="container py-5">
    <div class="header-box">
        <img src="../img/podologo.jpg" alt="Foto" class="avatar">
        <div>
            <h3 class="mb-0">Bienvenido <?= htmlspecialchars($nombre) ?></h3>
            <p class="mb-0">Especialidad: Podologia</p>
        </div>
    </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
                    ...
                    <p class="card-text">Finalizar tu sesion actual.</p>

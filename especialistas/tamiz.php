<?php
session_start();
if (!isset($_SESSION['id_especialista']) || $_SESSION['especialidad'] !== 'Tamizologo') {
...
<body class="container py-5">
    <div class="header-box">
        <img src="../img/tamiz.png" alt="Foto" class="avatar">
        <div>
            <h3 class="mb-0">Bienvenido <?= htmlspecialchars($nombre) ?></h3>
            <p class="mb-0">Especialidad: Tamiz</p>
        </div>
    </div>
